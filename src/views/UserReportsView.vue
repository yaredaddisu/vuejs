...
const reports = computed(() => store.state.currentReport.data);
const loading = computed(() => store.state.currentReport.loading);

store.dispatch("getUserReport", { search: search.value });

watch(search, (newValue, oldValue) => {
  store.dispatch("getUserReport", {
    search: search.value,
    sort_field: sortField.value,
    sort_direction: sortDirection.value,
  });
});
function getUserReport(url = null) {
  store.dispatch("getUserReport", {
    url,
    search: search.value,
    sort_field: sortField.value,
